...
def generate_pdf(interval="weekly"):
    ...
    story.append(
        Paragraph(
            ...
            f"<font color='#2563EB'><b>{html.escape(repo_name)}</b></font> "
            f"&nbsp;|&nbsp; <b>Branch:</b> "
        ...
        for student_name, logs in student_logs.items():
            ...
            t_style = [
                ...
                (
                    ...
                    (3, 1),
                    (3, num_rows - 1)
                ),  # Vertically merge mentor marks column
                (
                    'VALIGN',
                    (3, 1),
                    (3, num_rows - 1),
                    'MIDDLE'
                ),  # Vertically center the marks line
                (
                    'BACKGROUND',
                    (3, 1),
                    (3, num_rows - 1),
                    colors.HexColor("#FEF3C7")
                ),  # Accent for marks area
            ]
    ...
    if students:
        ...
        table_data.append(
            [
                ...
                "Run with 'final' to see all commits.",
                "-",
                "-",
                "-",
                "-",
...
>>>>>>> 25b9fca (ci: add automated Form-3 weekly reporting workflow)
